        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col s12 m6">
              ...
              <h5 class="start text-primarycolor">{!! $event->title !!}</h5>
              <p>{!!$event->description!!}</p>
              <p>On <span>{!!$event->date!!}</span> starting at <span>{{$event->startTime}} up To {{$event->endTime}}</span></p>
              <p>At <span>{{$event->place}}</span></p>
              <div class="chip">
            ...
            <div class="col s6 offset-s3 m6 center">
              ...
              <div class="card-content">
                <div class="row">
                    <div class="col s12 m12">
                     <img class="responsive-img" src="{{route('socials.image',$event->filename)}}">
                 </div> 
              </div>
             </div>
            </div>            
