    ...
    public function run()
    {
        ...
        //Instructors
               ...
               DB::table('professors')->insert([
                'eid'=>'10-0023',
                'last_name' => 'Reyes',
                'first_name' => 'Paul Mikee',
                'midle_name' => 'Salcedo',  
                'approved'=>true,
                'gender'=>'female',
                'email'=>'Paulmikee@sample.com',
                'password'=> bcrypt('sample'),
                'campus_id'=>'6',
                'status'=>'0',
                'filename'=>'teacher.png',
               ...
               DB::table('professors')->insert([
                'eid'=>'10-0024',
                'last_name' => 'Ollit',
                'first_name' => 'Paula Jane',
                'midle_name' => 'Tadeo',  
                'approved'=>true,
                'gender'=>'female',
                'email'=>'PaulaJane@sample.com',
                'password'=> bcrypt('sample'),
                'campus_id'=>'6',
                'status'=>'0',
                'filename'=>'teacher.png',
